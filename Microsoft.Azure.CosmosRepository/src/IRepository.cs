...
namespace Microsoft.Azure.CosmosRepository
{
    ...
    public interface IRepository<TItem> where TItem : Item
    {
        ...
        /// <returns>A <see cref="Task{TItem}"/> representing the <see cref="Item"/> subclass instance as a <typeparamref name="TItem"/>.</returns>
        ...
        Task<IEnumerable<TItem>> CreateAsync(IEnumerable<TItem> values, CancellationToken cancellationToken = default);
        ...
        Task DeleteAsync(TItem value, CancellationToken cancellationToken = default);
